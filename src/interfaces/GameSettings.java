 ...
 *  implementation detail to leak into the class's exported API. It is of no consequence to the users
 *  of a class that the class implements a constant interface. In fact, it may even confuse them.
 *  Worse, it represents a commitment: if in a future release the class is modified so that it no
 *  longer needs to use the constants, it still must implement the interface to ensure binary
 *  compatibility. If a nonfinal class implements a constant interface, all of its subclasses will have
...
//     * Dino option
//     */
//    int DINO_JUMP_STRENGTH = 12;
//    int DINO_FALL_STRENGTH = 8;
//    float DINO_START_X = 50;
//    int DINO_RUNNING_ANIMATION_DELTA_TIME = 60;
//
//    /**
//     * Score option
//     */
